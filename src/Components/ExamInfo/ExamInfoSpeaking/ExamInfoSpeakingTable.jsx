...
export default function ExamInfoSpeakingTable() {
    const tableData = [
        { id: 1, name: "1", score: "25", type: 'Matn yozish shaklida', Link: "part_1" },
        { id: 2, name: "2", score: "50", type: 'Rasm shaklida', Link: "part_2" },
        { id: 2, name: "3", score: "50", type: 'Rasm shaklida', Link: "part_3" },
    ];
                        ...
                        <tbody>
                            {tableData.map((row) => (
                                ...
                                >
                                    ...
                                    >
                                        <NavLink to={`/exam/1/speaking/${row?.Link}`}>
